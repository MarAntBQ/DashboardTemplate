document.getElementById("menu-btn").addEventListener("click", () => {
    var mobileMenu = document.getElementsByTagName("HEADER")[0];
    if (mobileMenu.classList == "" || mobileMenu.classList == "desactivate-menu") {
        ...
        document.getElementsByTagName("MAIN")[0].classList.add("darkmode");
    } else {
        mobileMenu.classList.add("desactivate-menu");
        document.getElementsByTagName("MAIN")[0].classList.remove("darkmode");
        setTimeout(function () {
